...
public class HelloControllerIT {
	...
	public void getQuery4() throws Exception {
		...
		assertThat(response.getBody(), equalTo("<h1>Route Finding: Johnson Creek NB to Columbia Blvd NB</h1><br><table border=\"1\"><tr><tr><td>Station ID</td><td>Location Text</td></tr></td><tr><tr><td>1046</td><td>Johnson Cr NB</td></tr><tr><td>1047</td><td>Foster NB</td></tr><tr><td>1117</td><td>Powell to I-205 NB</td></tr><tr><td>1048</td><td>Division NB</td></tr><tr><td>1142</td><td>Glisan to I-205 NB</td></tr><tr><td>1140</td><td>Columbia to I-205 NB</td></tr>"));
	}
	@Test
	public void getQuery5() throws Exception {
		...
		assertThat(response.getBody(), equalTo("Query 5: update the value of stationID: 1140 to have a length of 2.3 <br>StationID has an OLD length value of: 2.14<br>StationID has a NEW length value value of 2.3"));
	}
	@Test
