...
public class HelloControllerTest {
	...
	public void getQuery4() throws Exception {
		mvc.perform(MockMvcRequestBuilders.get("/query4/").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
				.andExpect(content().string(equalTo("<h1>Route Finding: Johnson Creek NB to Columbia Blvd NB</h1><br><table border=\"1\"><tr><tr><td>Station ID</td><td>Location Text</td></tr></td><tr><tr><td>1047</td><td>Johnson Cr NB</td></tr><tr><td>1117</td><td>Foster NB</td></tr><tr><td>1048</td><td>Powell to I-205 NB</td></tr><tr><td>1142</td><td>Division NB</td></tr><tr><td>1142</td><td>Division NB</td></tr><tr><td>1140</td><td>Columbia to I-205 NB</td></tr>")));
	}
	@Test
